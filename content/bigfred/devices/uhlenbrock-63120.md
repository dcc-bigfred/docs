...
[`hardware/04-uhlenbrock-63120.md`](../../hardware/04-uhlenbrock-63120.md).
...
[`hardware/04-uhlenbrock-63120.md` §4.2.1](../../hardware/04-uhlenbrock-63120.md#421-rb-lncv-on-linux).
...
Pinout and topology: [`hardware/02-loconet-electrical.md`](../../hardware/02-loconet-electrical.md).
...
into the Buildroot overlay ([`hardware/03-host-platform.md` §3.5](../../hardware/03-host-platform.md)).
...
Optional sanity check ([`hardware/06-bringup` §6.3](../../hardware/06-bringup-and-testing.md)):
...
| [`hardware/04`](../../hardware/04-uhlenbrock-63120.md) | Frame loss, Luisa, udev |
| [`hardware/05`](../../hardware/05-bigfred-integration.md) | Catalogue integration |
