...
[`07-z21-command-stations.md`](../../specs/hardware/07-z21-command-stations.md).
...
Hub OS enables `cdc_acm` so `/dev/ttyACM*` appears and gets `dialout` via udev,
but **`dcc-bus` has no LI100F driver**. Do **not** add a `loconet-*` udev symlink
for `28e9:018a`. Use **`z21`** over LAN/Wi‑Fi (`udp://<ip>:21105`).
...
Protocol: [`docs/bigfred/protos/z21.md`](../../specs/bigfred/protos/z21.md).
...
External observation: [`16-dcc-bus/09-external-state-observation.md`](../../specs/bigfred/architecture/16-dcc-bus/09-external-state-observation.md).
...
BigFred runbook — see
[`07-z21-command-stations.md` §7.5](../../specs/hardware/07-z21-command-stations.md#75-dual-protocol-centrals-best-effort).
...
| Document | Topic |
|----------|-------|
| [`hardware/07-z21`](../../specs/hardware/07-z21-command-stations.md) | Z21 path, checklist |
| [`protos/z21.md`](../../specs/bigfred/protos/z21.md) | Z21 LAN packets |
| [`protos/withrottle.md`](../../specs/bigfred/protos/withrottle.md) | WiThrottle (TCP 12090, Engine Driver) |
