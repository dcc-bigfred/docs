...
## [Hardware variants and limits](#1-hardware-variants-and-limits)

## [Address and programming](#2-address-and-programming)

## [Output mapping (function keys)](#3-output-mapping-function-keys)

## [Lighting effects](#4-lighting-effects)

## [Brightness](#5-brightness)

## [Power-on behaviour and analog mode](#6-power-on-behaviour-and-analog-mode)

## [Servo output](#7-servo-output)

## [RailCom® easy configuration](#8-railcom-easy-configuration)

## [Factory reset](#9-factory-reset)

## [A — Full CV table](#appendix-a--full-cv-table)
