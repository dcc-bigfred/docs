...
## [Overview and boot init](./01-overview-and-init.md)

Target hardware, read-only root with persistent `/data`, offline operation,
BusyBox init and `S*` boot scripts.

## [Hardware §8 Hub OS image](../hardware/08-hub-os-image.md)

Design goals, PREEMPT_RT, CPU isolation, storage sizing, and verification
checklist.
